...
import InsuranceLeftBackground from "../../../../assets/app/insurance/Default/left/left-insurance-background.JPG";
import "./Insurance.css";

function InsuranceLeft(props) {
	...
	// Redirect handlers
	const handleLeft = () => props.history.push("/streetView/insuranceSouth");
	const handleForward = () => props.history.push("/");
	const handleRight = () => props.history.push("/streetView/insuranceFront");
	const handleSouth = () => props.history.push("/streetView/insuranceRight");
