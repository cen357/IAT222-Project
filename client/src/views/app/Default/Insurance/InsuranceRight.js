...
import InsuranceRightBackground from "../../../../assets/app/insurance/Default/right/right-insurance-background.JPG";
import "./Insurance.css";

function InsuranceRight(props) {
	...
	// Redirect handlers
	const handleLeft = () => props.history.push("/streetView/insuranceFront");
	const handleForward = () => props.history.push("/");
	const handleRight = () => props.history.push("/streetView/insuranceSouth");
	const handleSouth = () => props.history.push("/streetView/insuranceLeft");
