...
import LeftDarkBackground from "../../../../../assets/app/green/dark/left/left_dark_background.png";
import { motion } from "framer-motion";

function LeftDarkGreen(props) {
	//******************************************************************************//
	// Hooks
	//******************************************************************************//
	...
	const handleLeft = () => {
		...
		props.history.push("/streetView/locations/green/dark/back");
	};

	const handleForward = () => {
		setBackgroundActive(0);
		setTimeout(() => {
			props.history.push("/streetView/locations/purple/dark/left");
		}, 2000);
	};

	const handleRight = () => {
		setBackgroundActive(0);
		props.history.push("/streetView/locations/green/dark/front");
	};
