...
import FrontDarkBackground from "../../../../../assets/app/green/dark/front/front_dark_background.png";
...
function FrontDarkGreen(props) {
	...
	const handleLeft = () => {
		...
		props.history.push("/streetView/locations/green/dark/left");
	};
