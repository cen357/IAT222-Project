...
import BackLightBackground from "../../../../../assets/app/green/light/back/back_light_background.png";
import { motion } from "framer-motion";

function BackLightGreen(props) {
	//******************************************************************************//
	// Hooks
	//******************************************************************************//
	...
	const handleLeft = () => {
		...
		props.history.push("/streetView/locations/green/light/right");
	};

	const handleForward = () => {
		setBackgroundActive(0);
		setTimeout(() => {
			props.history.push("/streetView/locations/red/light/back");
		}, 2000);
	};
