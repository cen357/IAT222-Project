...
import BackLightBackground from "../../../../../assets/app/red/dark/back/back_dark_background.png";
import { motion } from "framer-motion";

function BackLightRed(props) {
	//******************************************************************************//
	...
	const handleRight = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/red/dark/left",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
