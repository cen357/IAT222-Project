...
import RightDarkBackground from "../../../../../assets/app/red/dark/right/right_dark_background.png";
import { motion } from "framer-motion";
import GifPlayer from "react-gif-player";
import ViolentPopup1 from "../../../../../assets/app/green/dark/front/violent-popup-1.gif";

function RightDarkRed(props) {
	//******************************************************************************//
	// Hooks
	//******************************************************************************//
	...
	const handleLeft = () => {
		...
		props.history.push("/streetView/locations/red/dark/front");
	};

	const handleRight = () => {
		setBackgroundActive(0);
		props.history.push("/streetView/locations/red/dark/back");
	};
