...
import RightLightBackground from "../../../../../assets/app/red/dark/right/right_dark_background.png";
import { motion } from "framer-motion";

function RightLightRed(props) {
	//******************************************************************************//
	...
	const handleLeft = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/red/dark/front",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleRight = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/red/dark/back",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleGlitch = () => {
		setBackgroundActive(0);
		props.history.push({
			pathname: "/streetView/locations/red/dark/right",
			state: {
				animationCount,
				violentPopup1Lock,
				violentPopup2Lock,
