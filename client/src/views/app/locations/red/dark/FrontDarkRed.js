...
import FrontDarkBackground from "../../../../../assets/app/red/dark/front/front_dark_background.png";
import { motion } from "framer-motion";

function FrontDarkRed(props) {
	//******************************************************************************//
	// Hooks
	//******************************************************************************//
	...
	const handleLeft = () => {
		...
		props.history.push("/streetView/locations/red/dark/left");
	};
	...
	const handleRight = () => {
		setBackgroundActive(0);
		props.history.push("/streetView/locations/red/dark/right");
	};
