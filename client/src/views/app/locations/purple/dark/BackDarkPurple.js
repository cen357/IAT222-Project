...
import BackDarkBackground from "../../../../../assets/app/purple/dark/back/back_dark_background.png";
import { motion } from "framer-motion";

function BackDarkPurple(props) {
	//******************************************************************************//
	...
	const handleForward = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/orange/dark/back",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleLeft = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/purple/dark/right",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleRight = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/purple/dark/left",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleGlitch = () => {
		setBackgroundActive(0);
		props.history.push({
			pathname: "/streetView/locations/purple/dark/back",
			state: {
				animationCount,
				violentPopup1Lock,
				violentPopup2Lock,
