...
import BackLightBackground from "../../../../../assets/app/purple/light/back/back_light_background.png";
import { motion } from "framer-motion";

function BackLightPurple(props) {
	//******************************************************************************//
	// Hooks
	//******************************************************************************//
	...
	const handleLeft = () => {
		...
		props.history.push("/streetView/locations/purple/light/right");
	};

	const handleForward = () => {
		setBackgroundActive(0);
		setTimeout(() => {
			props.history.push("/streetView/locations/orange/light/back");
		}, 2000);
	};

	const handleRight = () => {
		setBackgroundActive(0);
		props.history.push("/streetView/locations/purple/light/left");
	};
...
export default BackLightPurple;
