...
import FrontLightBackground from "../../../../../assets/app/orange/light/front/front_light_background.png";
import { motion } from "framer-motion";

function FrontLightOrange(props) {
	//******************************************************************************//
	// Hooks
	//******************************************************************************//
	...
	const handleLeft = () => {
		...
		props.history.push("/streetView/locations/orange/light/left");
	};

	const handleForward = () => {
		setBackgroundActive(0);
		setTimeout(() => {
			props.history.push("/streetView/locations/purple/light/front");
		}, 2000);
	};

	const handleRight = () => {
		setBackgroundActive(0);
		props.history.push("/streetView/locations/orange/light/right");
	};
...
export default FrontLightOrange;
