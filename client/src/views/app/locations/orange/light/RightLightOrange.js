...
import RightLightBackground from "../../../../../assets/app/orange/light/right/right_light_background.png";
import { motion } from "framer-motion";

function RightLightOrange(props) {
	//******************************************************************************//
	...
	const handleForward = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/red/light/right",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleLeft = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/orange/light/front",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleRight = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/orange/light/back",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
...
export default RightLightOrange;
