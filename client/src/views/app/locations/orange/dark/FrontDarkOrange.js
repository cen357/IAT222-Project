...
import FrontNormalBackground from "../../../../../assets/app/orange/dark/front/front_dark_background.png";
...
function FrontNormalOrange(props) {
	...
	const handleForward = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/purple/dark/front",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleLeft = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/orange/dark/left",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleRight = () => {
		...
		setTimeout(() => {
			props.history.push({
				pathname: "/streetView/locations/orange/dark/right",
				state: {
					animationCount,
					violentPopup1Lock,
					violentPopup2Lock,
	...
	const handleGlitch = () => {
		setBackgroundActive(0);
		props.history.push({
			pathname: "/streetView/locations/orange/dark/front",
			state: {
				animationCount,
				violentPopup1Lock,
				violentPopup2Lock,
...
export default FrontNormalOrange;
