...
import FrontDarkBackground from "../../../../../assets/app/orange/dark/front/front_dark_background.png";
import { motion } from "framer-motion";

function FrontDarkOrange(props) {
	//******************************************************************************//
	// Hooks
	//******************************************************************************//
	...
	const handleLeft = () => {
		...
		props.history.push("/streetView/locations/orange/dark/left");
	};

	const handleForward = () => {
		setBackgroundActive(0);
		setTimeout(() => {
			props.history.push("/streetView/locations/purple/dark/front");
		}, 2000);
	};

	const handleRight = () => {
		setBackgroundActive(0);
		props.history.push("/streetView/locations/orange/dark/right");
	};
...
export default FrontDarkOrange;
